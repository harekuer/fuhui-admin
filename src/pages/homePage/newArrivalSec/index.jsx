        ...
        {editing ? (
          <Form.Item style={{ margin: 0 }}>
            {getFieldDecorator(dataIndex, {
              rules: [
                {
                  required: record.module === 'index-newest2-image' && (dataIndex === 'title' || dataIndex === 'content')? false : true,
...
class TableList extends React.Component {
    ...
    save(form, currentKey) {
        form.validateFields((error, row) => {
            ...
            const { dispatch, newArrivalSecond} = this.props;
            let { list,key,lang } = newArrivalSecond;
            const newData = list;
