...
class EditableCell extends React.Component {
  getInput = (record, setFieldsValue) => {
    if (this.props.inputType === 'upload') {
      if(record.module === 'index-newest1-cate'){
        return <SingleUpload
        limit={2}
        ...
        {editing ? (
          <Form.Item style={{ margin: 0 }}>
            {getFieldDecorator(dataIndex, {
              rules: [
                {
                  required: record.module === 'index-newest1-image' && (dataIndex === 'title' || dataIndex === 'content')? false : true,
...
@connect(({ newArrival, loading }) => ({
    newArrival,
    loading: loading.models.newArrival,
}))
...
class TableList extends React.Component {
    ...
    columnList = () => {
      ...
      let column = [
        ...
        {
          title: key === 'index-newest1-cate'? '分类': '标题',
          dataIndex: 'title',
          key: 'title',
          editable: true,
        },
              ...
              newData.splice(index, 1, { ...item, ...row });
                dispatch({
                    ...
                    payload: {
                        ...
                        url: row.url,
                        title: row.title,
                        content: key === 'index-newest1-image'? row.content : undefined,
                    },
                })
                this.setState({
                    editingKey: '',
      ...
      return (
        <Card bordered={false}>
          ...
          <Tabs  onChange={this.onChangeTab} type="card">
            ...
            <TabPane tab="右侧分类" key="index-newest1-cate">
              <EditableContext.Provider value={this.props.form}>
                  <DndProvider backend={HTML5Backend}>
                  <Table
                      columns={columns}
